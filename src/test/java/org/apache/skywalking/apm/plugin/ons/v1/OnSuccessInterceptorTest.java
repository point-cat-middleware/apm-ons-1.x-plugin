...
public class OnSuccessInterceptorTest {
    ...
    @Test
    public void testOnSuccessNeedFilter() throws Throwable {
        SendCallBackEnhanceInfo needFilterenhanceInfo = new SendCallBackEnhanceInfo("rmq_sys_TRACE_DATA_cn-qingdao-publictest", contextSnapshot);
        when(enhancedInstance.getSkyWalkingDynamicField()).thenReturn(needFilterenhanceInfo);
