...
public class MessageSendInterceptorTest {
    ...
    private Object[] argumentsNeedFilter;

    @Mock
    private Message message;

    @Mock
    private Message needFilterMessage;
    ...
    public void setUp() {
        ...
        argumentsNeedFilter = new Object[] {
                "127.0.0.1",
                "test",
                needFilterMessage,
                messageRequestHeader,
        ...
        when(needFilterMessage.getTopic()).thenReturn("rmq_sys_TRACE_DATA_cn-qingdao-publictest");
    }
    ...
    @Test
    public void testSendMessageNeedFilter() throws Throwable {
        messageSendInterceptor.beforeMethod(enhancedInstance, null, argumentsNeedFilter, null, null);
        messageSendInterceptor.afterMethod(enhancedInstance, null, argumentsNeedFilter, null, null);

        assertThat(segmentStorage.getTraceSegments().size(), is(0));
        verify(callBack).setSkyWalkingDynamicField(any(SendCallBackEnhanceInfo.class));
    }
}
